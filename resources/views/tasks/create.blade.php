<x-master>
	<section class="container mx-auto p-5 w-1/3 bg-white rounded">
		<h1 class="font-bold text-xl text-center">Create New Task</h1>
		...
		<form method="POST" action="/task">
			...
			<div class="inline">
				...
				<select name="priority" class="shadow appearance-none border mx-4 p-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline w-11/12" value="{{ old('priority') }}" required>
